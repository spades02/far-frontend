...
const SignupThirdParty = () => {
  ...
  function onSubmit(data) {
    ...
    if (data.type === "student") {
      ...
      navigate("/welcome_student");
    } else if (data.type === "preceptor") {
      navigate("/welcome_preceptor");
    }
  }
      ...
      <div className="flex flex-col rounded-lg h-auto w-1/2 sm:w-1/4 p-10 shadow-lg border-1 drop-shadow-md">
        ...
        <Form {...form}>
          ...
          >
                    ...
                    <PopoverTrigger>
                      <FormControl>
                        <Button
                          ...
                          role="combobox"
                          onClick={() =>
                            setReferralPopoverOpen(!referralPopoverOpen)
                          }
                          className={cn(
            ...
            <Button className="bg-indigo-600 w-full mt-4" type="submit">
              Create My Account
            </Button>
          </form>
        </Form>
